...
def ref_state():
    ...
    state = apply_excitation(state,  n_qubits=8, n_elec_s=4, ex_op=(4, 0, 3, 7), mode="fermion", numeric_engine=numeric_engine_ref)
...
def excitation_no_ref(numeric_engine):
    uccsd = UCCSD(h4)
