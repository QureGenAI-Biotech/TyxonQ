...
#     e, g = uccsd.energy_and_grad(params, numeric_engine="tensornetwork")
    
#     return e, g


@pytest.mark.parametrize("numeric_engine", ["statevector", "civector", "civector-large", "pyscf"])
def test_gradient(ref_eg, numeric_engine, reset_backend):
    e_ref, g_ref = ref_eg
    ...
    e, g = uccsd.energy_and_grad(params, numeric_engine=numeric_engine)
...
@pytest.mark.parametrize("numeric_engine", ["statevector", "civector", "civector-large", "pyscf"])
def test_excitation(ref_state, numeric_engine, reset_backend):
    uccsd = UCCSD(h4)
...
def test_gradient_signle_opt(backend_str, numeric_engine, init_state, mode):
    ...
    try:
        ...
        uccsd = UCCSD(h4, mode=mode, numeric_engine=numeric_engine)
